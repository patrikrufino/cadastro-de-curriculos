...
<div class="w3-padding-large" id="main">
    ...
    <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
        ...
        <form action="Navegacao.php" method="post" class=" w3-row  w3-light-grey w3-text-blue w3-margin" style="width: 70%;">
...
<div class="w3-padding-128 w3-content w3-text-grey" id="OFormacao">
        ...
        <form action="Navegacao.php" method="post" class=" w3-row  w3-light-grey w3-text-blue w3-margin" style="width: 70%;">
            ...
            <div class="w3-row w3-section">
                ...
                <div class="w3-rest">
                    <input class="w3-input w3-border w3-round-large" name="txtDescOF" type="text" placeholder="Descrição: Ex.: Sistemas para Internert - Centro Paula Souza">
                </div>
            </div>
